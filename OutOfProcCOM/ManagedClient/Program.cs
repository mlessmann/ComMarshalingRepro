...
namespace ManagedClient
{
    class Program
    {
        static void Main(string[] _)
        {
            ...
            try
            {
                Console.WriteLine("server.MethodWithArrayArgs(new object[] { \"param1\" }, new object[] { \"param2\" })");
                Console.WriteLine(server.MethodWithArrayArgs(new object[] { "param1" }, new object[] { "param2" }));
            }
            catch (Exception e)
            {
            ...
            try
            {
                Console.WriteLine("server.MethodWithArrayArgs(new[] { \"param1\" }, null)");
                Console.WriteLine(server.MethodWithArrayArgs(new object[] { "param1" }, null));
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
            ...
            try
            {
                Console.WriteLine("server.Name = \"MyName\"");
                Console.WriteLine(server.Name = "MyName");
            }
            catch (Exception e)
            {
            ...
            try
            {
                Console.WriteLine("server.Name = null");
                Console.WriteLine(server.Name = null);
            }
            catch (Exception e)
            {
